...
const RightSidebar = () => {
  return (
    <div className="h-178 bg-[#F3F2F2] w-60 flex flex-col gap-5 p-4">
      ...
      <div className="flex flex-col bg-white p-2 rounded-lg">
        ...
        <div className="flex justify-between ">
          <div className="flex flex-col items-center gap-1">
            <div className="h-7 w-7 rounded-sm bg-[#FFF5CC] text-[#E29537] text-xl flex justify-center items-center">
              <MdOutlineStar />
            </div>
          ...
          <div className="flex flex-col items-center gap-1 text-[#ABABAB]">
            <div className="h-7 w-7 rounded-sm text-xl flex justify-center items-center">
              <MdOutlineStar />
            </div>
      ...
      <div className="flex flex-col bg-white p-2 rounded-lg">
        ...
        <div className="flex justify-evenly">
          <div className="flex flex-col items-center">
            <div className="h-8 w-8 bg-[#EDEDED] rounded-sm flex justify-center items-center">
              <FiBookOpen />
            </div>
            <h6>128</h6>
        ...
        <div className="flex flex-col gap-4">
          <div className="px-2 flex flex-col gap-1">
            ...
            <div className="w-full h-1 rounded-full bg-[#D9D9D9]">
              <div className="w-[90%] h-full bg-[#1BA53B] rounded-full">
              </div>
            </div>
          </div>
          <div className="px-2 flex flex-col gap-1">
            ...
            <div className="w-full h-1 rounded-full bg-[#D9D9D9]">
              <div className="w-[85%] h-full bg-[#1BA53B] rounded-full">
              </div>
            </div>
          </div>
          <div className="px-2 flex flex-col gap-1">
            ...
            <div className="w-full h-1 rounded-full bg-[#D9D9D9]">
              <div className="w-[70%] h-full bg-[#1BA53B] rounded-full">
              </div>
            </div>
          </div>
          <div className="px-2 flex flex-col gap-1">
            ...
            <div className="w-full h-1 rounded-full bg-[#D9D9D9]">
              <div className="h-full bg-[#1BA53B] rounded-full">
              </div>
            </div>
          </div>
        </div>
